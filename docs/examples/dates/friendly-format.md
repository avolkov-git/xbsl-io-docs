...
В данном примере разбираем представление на примере типа **Момент**, при необходимости, вы вснгда можете выполнить **ВМомент()** над требуемым типом, например **ДатаВремя**
